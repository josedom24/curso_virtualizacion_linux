...
* La variante del sistema operativo que vamos a utilizar (parámetro `--os-variant`). Para obtener la lista de variantes de sistemas operativos, podemos ejecutar `osinfo-query os` (Instalar el paquete `libosinfo-bin` si no reconoce el comando). 
